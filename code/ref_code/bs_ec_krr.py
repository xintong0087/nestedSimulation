...
def cal_RRMSE(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, alpha, L0, alpha_opt, l_opt, nu_opt):
    ...
    loss = krr_Euro_Call(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, alpha_opt, l_opt, nu_opt)
...
for _j in range(n_trials):
    ...
    res = Parallel(n_jobs=40, verbose=10)(delayed(cal_RRMSE)(n_front_11, n_back_11, d_11, S_0_11, K_11,
...
print(result_table)
np.save("data/result_116.npy", result_table)
