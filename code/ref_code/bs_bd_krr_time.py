...
def cal_RRMSE(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, D, alpha, L0, alpha_opt, l_opt, nu_opt):
    ...
    loss, time_sim, time_sim_pred, time_fit, time_pred = krr_Barrier_D(n_front, n_back,
...
for _j in range(n_trials):
    ...
    res = Parallel(n_jobs=20, verbose=10)(delayed(cal_RRMSE)(n_front_14, n_back_14, d_14, S_0_14, K_14,
                                                            ...
                                                            alpha_opt_14, l_opt_14, nu_opt_14)
...
print(result_table)
np.save("data/result_146_time.npy", result_table)
