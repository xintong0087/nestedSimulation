...
def cal_RRMSE(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, U, alpha, L0, alpha_opt, l_opt, nu_opt):
    ...
    loss, time_sim, time_sim_pred, time_fit, time_pred = krr_Barrier_U(n_front, n_back,
...
for _j in range(n_trials):
    ...
    res = Parallel(n_jobs=20, verbose=10)(delayed(cal_RRMSE)(n_front_13, n_back_13, d_13, S_0_13, K_13,
                                                            ...
                                                            h_13, U_13, alpha_13, L0_13,
                                                             alpha_opt_13, l_opt_13, nu_opt_13)
...
print(result_table)
np.save("data/result_136_time.npy", result_table)
