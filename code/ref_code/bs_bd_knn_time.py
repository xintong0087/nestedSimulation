...
def knn_Barrier_D(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, H, k_opt=-1):
...
def cal_RRMSE(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, D, alpha, L0, k_opt):

    loss, time_sim, time_sim_pred, time_fit, time_pred = knn_Barrier_D(n_front, n_back,
                                                                       d, S_0, K, mu, sigma, r, tau, T, h, D, k_opt)
...
for _j in range(n_trials):
    ...
    start_cv = time.time()
    k_cv = cv_kNN(n_front_14, n_back_14, d_14, S_0_14, K_14, mu_14, sigma_14, r_14, tau_14, T_14, D_14, h_14)
    ...
    print("kNN Estimation Done for:", n_front_14, "x", n_back_14)
    print(time_vec, time_cv)

print(result_table)
np.save("data/result_144_time.npy", result_table)
