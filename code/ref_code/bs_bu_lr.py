...
def cal_RRMSE(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, U, alpha, L0):
    ...
    loss = lr_Barrier_U(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, U)
...
for _j in range(n_trials):
    ...
    res = Parallel(n_jobs=50, verbose=100)(delayed(cal_RRMSE)(n_front_13, n_back_13, d_13, S_0_13, K_13,
...
print(result_table)
np.save("data/result_135.npy", result_table)