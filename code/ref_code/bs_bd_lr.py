...
def cal_RRMSE(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, D, alpha, L0):
    ...
    loss = lr_Barrier_D(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, D)
...
for _j in range(n_trials):
    ...
    res = Parallel(n_jobs=50, verbose=100)(delayed(cal_RRMSE)(n_front_14, n_back_14, d_14, S_0_14, K_14,
...
print(result_table)
np.save("data/result_145.npy", result_table)
