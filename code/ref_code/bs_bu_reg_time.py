...
def reg_Barrier_U(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, H):
...
def cal_RRMSE(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, U, alpha, L0):
    ...
    loss, time_sim, time_sim_pred, time_fit, time_pred = reg_Barrier_U(n_front, n_back,
...
for _j in range(n_trials):
    ...
    print("Regression Estimation Done for:", n_front_13, "x", n_back_13)
    print(time_vec, time_cv)

print(result_table)
np.save("data/result_133_time.npy", result_table)
