...
def reg_Barrier_D(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, H):
...
def cal_RRMSE(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, D, alpha, L0):
    ...
    loss, time_sim, time_sim_pred, time_fit, time_pred = reg_Barrier_D(n_front, n_back,
...
for _j in range(n_trials):
    ...
    print("Regression Estimation Done for:", n_front_14, "x", n_back_14)
    print(time_vec, time_cv)

print(result_table)
np.save("data/result_143_time.npy", result_table)
