...
def cal_RRMSE(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, alpha, L0, k_opt):
    ...
    loss = knn_Geo_Asian(n_front, n_back, d, S_0, K, mu, sigma, r, tau, T, h, k_opt)
...
#
#     res = Parallel(n_jobs=-1, verbose=10)(delayed(cal_RRMSE)(n_front_12, n_back_12, d_12, S_0_12, K_12,
...
#
# print(result_table)
# np.save("data/result_124.npy", result_table)
